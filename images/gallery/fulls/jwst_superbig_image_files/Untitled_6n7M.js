...
ot_b=ot_is+'gm02e.opentracker.net';
...
ot_cd=_2_years_from_now.toGMTString();ot_cld=new Date();ot_fv=false;ot_ac=false;
...
if(ot_c.cookie.indexOf('machine-id')!=-1)ot_ac=true;else{
 if(ot_c.cookie.indexOf('machine-id')==-1) f_sc("machine-id","158.220.78.37:1782053611916",ot_cd,"/");
 if(ot_c.cookie.indexOf('machine-id')!=-1)ot_ac=true;
}
ot_rc=f_rc("machine-id");ot_lc=escape((typeof ot_url===ot_un)?ot_d.location:ot_url);ot_t0=1782053611916;
...
function _ot_send(m,e){
  ...
  if(!e) {
   ot_im=new Image(1,1);
   ot_im.src=ot_is+'log.opentracker.net/?si=www.collectspace.com&uid='+_ot_uid()+'&sid='+_ot_sid()+'&'+_ot_u(m)+'&pix&rnd='+_j(5);

  }else{
   _re();
   ot_im=new Image(1,1);
   ot_im.src=ot_is+'log.opentracker.net/?si=www.collectspace.com'
...
function f_log(send) {
 ...
 ot_im.src=ot_b+'/collect.jsp?p=1&mid='+ot_rc
  +'&fv='+ot_fv+'&ti='+ot_ti+'&si=www.collectspace.com'
  +ot_goal+ot_clv
...
function ot_f(e) {
 ...
 ot_im=new Image(1,1);
 ot_im.src=ot_b+'/collect_.jsp?p=3&mid='+ot_rc+'&si=www.collectspace.com&ms='+ot_l+'&lc='+ot_lc+'&ti='+ot_ti+'&t0='+ot_t0;
...
ot_im=new Image(1,1);
ot_im.src=ot_b+'/collect_.jsp?p=2&mid='+ot_rc+'&si=www.collectspace.com&ms='+m+'&lc='+ot_lc+'&ti='+ot_ti+'&t0='+ot_t0;
